    ...
    <div className="login-page">
      ...
      <div className="login-card">
        ...
        <p className="login-subtitle">
          Sign in to access the transport data collection portal.
        </p>

        {/* Admin email hint banner */}
        {showAdminRedirect && (
          <div style={{
            ...
            🛡️ That looks like an <strong style={{ color: '#fff' }}>admin email</strong>.{' '}
            Please log in via the{' '}
            <Link href="/admin/login" style={{ color: 'var(--accent)', textDecoration: 'underline', fontWeight: 600 }}>
              Admin Portal
            </Link>{' '}
            instead.
          </div>
